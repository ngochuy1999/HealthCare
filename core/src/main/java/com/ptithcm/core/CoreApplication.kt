...
open class CoreApplication : Application() {
    ...
    override fun onCreate() {
        ...
        accountBio = prefsUtil.accountBio
...
//    }
    ...
    fun saveAccountBio(accountBio: Account) {
        prefsUtil.accountBio = accountBio
        this.accountBio = accountBio
    }

    fun clearAccountBio() {
        prefsUtil.accountBio = null
