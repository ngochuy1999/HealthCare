...
import com.ptithcm.healthcare.databinding.FragmentRatingBinding
...
import com.ptithcm.healthcare.view.rating.adapter.RatingAdapter
import com.ptithcm.healthcare.view.rating.adapter.RatingAdapter.Companion.ITEM_IMAGE
...
class RatingFragment : BaseFragment<FragmentRatingBinding>() {
    ...
    private val adapter: RatingAdapter by lazy {
        RatingAdapter(this::adapterEvent, CoreApplication.instance.account?.accountId)
    }
