package com.ptithcm.healthcare.view.changepassword
...
import com.ptithcm.healthcare.databinding.FragmentChangePasswordBinding
...
import com.ptithcm.healthcare.ext.togglePassword
            ...
            R.id.btn_change -> {
                ...
                if (checkValidUpdate()) {
                    userViewModel.changePassword(
                        ChangePassParam(
                            userid = CoreApplication.instance.account?.accountId,
