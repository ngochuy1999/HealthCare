...
import com.ptithcm.healthcare.databinding.FragmentListDoctorBinding
...
class ListDoctorFragment : BaseFragment<FragmentListDoctorBinding>() {

    override val layoutId: Int = R.layout.fragment_list_doctor

    private val viewModel: HomeViewModel by viewModel()
    private lateinit var doctorAdapter: DoctorRecyclerViewAdapter
    private var specialize: Specialize? = null
    ...
    override fun bindEvent() {
        ...
        viewBinding.rvListDoctor.setHasFixedSize(true)
        viewBinding.rvListDoctor.setItemViewCacheSize(20)
    ...
    override fun bindViewModel() {
        ...
        viewModel.allDoctorLiveData.observe(this, Observer {
