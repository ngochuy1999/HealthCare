...
import com.ptithcm.healthcare.databinding.FragmentShoppingBagBinding
import com.ptithcm.healthcare.databinding.LayoutPopUpDeleteItemBinding
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btnStartShopping -> {
                val isShopSelected =
                    (requireActivity() as? MainActivity)?.viewBinding?.btnNav?.selectedItemId == R.id.nav_home
