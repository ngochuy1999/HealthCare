...
object MyPatterns {
    ...
    private const val HASH_TAG_REGEX = "\\B#[\\w]+"
    val AUTOLINK_HASH_TAG: Pattern = Pattern.compile(HASH_TAG_REGEX)

    private const val MENTION_REGEX = "\\B@[\\w.*]+"
    val AUTOLINK_MENTION: Pattern = Pattern.compile(MENTION_REGEX)
}